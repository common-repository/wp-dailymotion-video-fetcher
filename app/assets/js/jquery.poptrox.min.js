    ...
    e.fn.poptrox_disableSelection = function () {
        ...
        return u.on("resize orientationchange", function () {
            ...
            if ("ignore" != n && p.attr("href")) {
                ...
                console.log(t.src.match(/\/\/([a-z0-9\.]+)\/.*/));
                if (!t.type)
                    
                    switch (i = t.src.match(/\/\/([a-z0-9\.]+)\/.*/), (!i || i.length < 2) && (i = [!1]), i[1]) {
                ...
                switch (i = t.src.match(/\/\/[a-z0-9\.]+\/(.*)/), t.type) {
                    ...
                    case "vimeo":
                        ...
                        break;
                    case "dailymotion":
                        t.object = e('<iframe src="" frameborder="0" allowFullScreen="1"></iframe>'), t.src = "http://www.dailymotion.com/embed/video/" + i[1] + (t.options ? "?" + t.options : ""), t.width && t.height || (t.width = "800", t.height = "480");
                        break;
                    case "wistia":
